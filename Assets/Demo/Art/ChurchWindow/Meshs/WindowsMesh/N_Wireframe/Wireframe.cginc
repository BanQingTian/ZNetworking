...
v2g vert (appdata v)
{
	...
	o.uv2 = TRANSFORM_TEX(v.uv, _MaskAll);
	return o;
}
...
void geom(triangle v2g i[3], inout TriangleStream<g2f> triangleStream)
{
	...
	o.uv = TRANSFORM_TEX(i[0].uv, _Mask);
	o.uv2 = TRANSFORM_TEX(i[0].uv2, _MaskAll);
    ...
    o.dist.w = 1.0 / o.projectionSpaceVertex.w;
	o.uv = TRANSFORM_TEX(i[1].uv, _Mask);
    ...
    o.dist.w = 1.0 / o.projectionSpaceVertex.w;
	o.uv = TRANSFORM_TEX(i[2].uv, _Mask);
...
fixed4 frag(g2f i) : SV_Target
{
	...
	fixed4 maskCol = tex2D(_Mask, float2(i.uv.x, i.uv.y + _Time.y));
	fixed4 maskAllCol = tex2D(_MaskAll, i.uv2);
    ...
    fixed4 finalColor = lerp(_BaseColor, _WireColor, t)*maskCol*maskAllCol;
