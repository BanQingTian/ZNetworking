Shader "FishFlock/FishShaderCPUInstanced" 
{
   Properties 
   {
	...
	SubShader 
	{
        ...
        float3 fishPosition;
            ...
            StructuredBuffer<FishBehaviourCPU2> fishBuffer;
         #endif
        ...
        {
            #ifdef UNITY_PROCEDURAL_INSTANCING_ENABLED
			FishBehaviourCPU2 fish = fishBuffer[unity_InstanceID];
