...
Shader "Ciconia Studio/Effects/Glass/Double Sided/Fast Glass" {
    Properties {
        [Space(15)][Header(Main Properties)]
        [Space(10)]_ColorGlass ("Color Glass", Color) = (1,1,1,1)
        [Space(10)]_EmissiveIntensity ("Emissive Intensity", Range(0, 2)) = 0
        [Space(10)]_SpecColor ("Specular Color", Color) = (1,1,1,1)
        ...
        [Space(25)]_Cubemap ("Cubemap", Cube) = "_Skybox" {}
        _ReflectionIntensity ("Reflection Intensity", Range(0, 10)) = 2
        _BlurReflection ("Blur Reflection", Range(0, 8)) = 0

        [Space(15)][Header(Glass Properties)]
        [Space(25)]_Refraction ("Refraction", Range(0, 2)) = 0.2
...
////// Specular:
                ...
                float3 Specularmap = (_SpecColor.rgb*_SpecularIntensity);
                float3 specularColor = Specularmap;
                float specularMonochrome;
                float3 DiffuseColor = _ColorGlass.rgb;
                float3 diffuseColor = DiffuseColor; // Need this for specular when using metallic
...
////// Emissive:
                float3 Emissivemap = (DiffuseColor*_EmissiveIntensity);
