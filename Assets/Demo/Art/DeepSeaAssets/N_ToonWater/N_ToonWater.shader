Shader "nreal/Roystan/N_ToonWater"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				float4 waterColor = _DepthGradientShallow;
				...
				float4 maskCol = tex2D(_Mask, i.noiseUV);
				...
				float surfaceNoiseSample = 1-tex2D(_SurfaceNoise, noiseUV).r;
				...
				return alphaBlend(surfaceNoiseColor, waterColor)*maskCol;
            }
            ENDCG
        }
    }
